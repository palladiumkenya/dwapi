...
{
    public class TempPncVisitExtractErrorSummaryRepository: TempMnchExtractErrorSummaryRepository<TempPncVisitExtractErrorSummary>, ITempPncVisitExtractErrorSummaryRepository{public TempPncVisitExtractErrorSummaryRepository(ExtractsContext context) : base(context){}}
}
