...
{ 
    public class HtsClientTestsExtractRepository : BaseRepository<HtsClientTests, Guid>, IHtsClientTestsExtractRepository
    {
        public HtsClientTestsExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<HtsClientTests> extracts)
        {
        ...
        public IEnumerable<HtsClientTests> GetView()
        {
