...
namespace Dwapi.UploadManagement.Core.Services.Hts
{
    public class HtsSendService : IHtsSendService
    {
        ...
        public HtsSendService(IDwhPackager packager, IDwhExtractReader reader, IExtractStatusService extractStatusService, IEmrSystemRepository emrSystemRepository)
        {
            _packager = packager;
            _reader = reader;
