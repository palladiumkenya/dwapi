...
{
    public class TempRelationshipsExtractRepository : BaseRepository<TempRelationshipsExtract, Guid>, ITempRelationshipsExtractRepository
    {
        public TempRelationshipsExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempRelationshipsExtract> extracts)
        {
