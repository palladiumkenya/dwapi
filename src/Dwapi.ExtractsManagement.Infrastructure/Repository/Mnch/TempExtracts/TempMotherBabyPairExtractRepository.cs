...
{
    public class TempMotherBabyPairExtractRepository : BaseRepository<TempMotherBabyPairExtract, Guid>, ITempMotherBabyPairExtractRepository
    {
        public TempMotherBabyPairExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempMotherBabyPairExtract> extracts)
        {
