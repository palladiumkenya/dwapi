...
{
    [Table("vTempEnhancedAdherenceCounsellingExtractError")]
    public class TempEnhancedAdherenceCounsellingExtractError : TempExtract,IEnhancedAdherenceCounselling
    {
