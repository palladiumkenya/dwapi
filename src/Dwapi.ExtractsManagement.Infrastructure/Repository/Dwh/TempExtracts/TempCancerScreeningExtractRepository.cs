...
{
    public class TempCancerScreeningExtractRepository : BaseRepository<TempCancerScreeningExtract, Guid>, ITempCancerScreeningExtractRepository
    {
        public TempCancerScreeningExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempCancerScreeningExtract> extracts)
        {
