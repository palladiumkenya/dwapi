...
{
    public class TempMnchEnrolmentExtractRepository : BaseRepository<TempMnchEnrolmentExtract, Guid>, ITempMnchEnrolmentExtractRepository
    {
        public TempMnchEnrolmentExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempMnchEnrolmentExtract> extracts)
        {
