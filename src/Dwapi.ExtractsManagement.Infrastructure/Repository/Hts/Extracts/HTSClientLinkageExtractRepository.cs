...
{
    public class HTSClientLinkageExtractRepository : BaseRepository<HTSClientLinkageExtract, Guid>, IHTSClientLinkageExtractRepository
    {
        public HTSClientLinkageExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<HTSClientLinkageExtract> extracts)
        {
