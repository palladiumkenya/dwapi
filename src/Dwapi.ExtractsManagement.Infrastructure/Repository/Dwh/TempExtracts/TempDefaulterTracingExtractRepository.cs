...
{
    public class TempDefaulterTracingExtractRepository : BaseRepository<TempDefaulterTracingExtract, Guid>, ITempDefaulterTracingExtractRepository
    {
        public TempDefaulterTracingExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempDefaulterTracingExtract> extracts)
        {
