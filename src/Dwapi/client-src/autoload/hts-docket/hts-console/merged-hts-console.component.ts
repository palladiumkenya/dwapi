...
@Component({
    selector: 'liveapp-merged-hts-console',
    templateUrl: './merged-hts-console.component.html',
    styleUrls: ['./merged-hts-console.component.scss']
})
export class MergedHtsConsoleComponent implements OnInit, OnDestroy, OnChanges {
    @Input() emr: EmrSystem;
    @Input() emrVer: string;
