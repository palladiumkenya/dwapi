...
@Component({
    selector: 'liveapp-merged-mnch-console',
    templateUrl: './merged-mnch-console.component.html',
    styleUrls: ['./merged-mnch-console.component.scss']
})
export class MergedMnchConsoleComponent implements OnInit, OnDestroy, OnChanges {
    @Input() emr: EmrSystem;
    @Input() emrVer: string;
