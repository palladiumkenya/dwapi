...
{
    public class TempHeiExtractRepository : BaseRepository<TempHeiExtract, Guid>, ITempHeiExtractRepository
    {
        public TempHeiExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempHeiExtract> extracts)
        {
