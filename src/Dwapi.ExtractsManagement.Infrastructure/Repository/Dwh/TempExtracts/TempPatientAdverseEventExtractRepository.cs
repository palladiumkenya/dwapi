...
{
    public class TempPatientAdverseEventExtractRepository : BaseRepository<TempPatientAdverseEventExtract, Guid>, ITempPatientAdverseEventExtractRepository
    {
        public TempPatientAdverseEventExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempPatientAdverseEventExtract> extracts)
        {
