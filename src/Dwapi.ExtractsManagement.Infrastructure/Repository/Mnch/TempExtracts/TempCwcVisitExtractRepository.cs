...
{
    public class TempCwcVisitExtractRepository : BaseRepository<TempCwcVisitExtract, Guid>, ITempCwcVisitExtractRepository
    {
        public TempCwcVisitExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempCwcVisitExtract> extracts)
        {
