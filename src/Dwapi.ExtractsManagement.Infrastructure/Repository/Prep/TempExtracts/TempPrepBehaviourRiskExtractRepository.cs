...
{
    public class TempPrepBehaviourRiskExtractRepository : BaseRepository<TempPrepBehaviourRiskExtract, Guid>, ITempPrepBehaviourRiskExtractRepository
    {
        public TempPrepBehaviourRiskExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempPrepBehaviourRiskExtract> extracts)
        {
