...
namespace Dwapi.ExtractsManagement.Infrastructure.Validators.Mgs
{
    public class MetricExtractValidator : IMetricExtractValidator
    {
        private readonly IValidatorRepository _validatorRepository;

        public MetricExtractValidator(IValidatorRepository validatorRepository)
        {
