...
{
    public class TempOtzExtractRepository : BaseRepository<TempOtzExtract, Guid>, ITempOtzExtractRepository
    {
        public TempOtzExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempOtzExtract> extracts)
        {
