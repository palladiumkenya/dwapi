...
@Component({
  selector: 'liveapp-merged-mnch-docket',
  templateUrl: './mnch-docket.component.html',
  styleUrls: ['./mnch-docket.component.scss']
})
export class MergedMnchDocketComponent implements OnInit, OnDestroy {
