...
namespace Dwapi.ExtractsManagement.Core.Tests.Extractors.Hts
{
    ...
    public class HtsClientsLinkageSourceExtractorTests
    {
        ...
        public void should_Exract_From_Reader_MsSql()
        {
            ...
            var extractor = TestInitializer.ServiceProvider.GetService<IHtsClientsLinkageSourceExtractor>();
        ...
        public void should_Exract_From_Reader_MySql()
        {
            ...
            var extractor = TestInitializer.ServiceProviderMysql.GetService<IHtsClientsLinkageSourceExtractor>();
