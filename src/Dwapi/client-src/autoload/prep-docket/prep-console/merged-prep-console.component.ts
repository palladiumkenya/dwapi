...
@Component({
    selector: 'liveapp-merged-prep-console',
    templateUrl: './merged-prep-console.component.html',
    styleUrls: ['./merged-prep-console.component.scss']
})
export class MergedPrepConsoleComponent implements OnInit, OnDestroy, OnChanges {
    @Input() emr: EmrSystem;
    @Input() emrVer: string;
