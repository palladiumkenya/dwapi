...
namespace Dwapi.ExtractsManagement.Infrastructure.Validators.Hts
{
    public class HtsExtractValidator : IHtsExtractValidator
    {
        private readonly IValidatorRepository _validatorRepository;

        public HtsExtractValidator(IValidatorRepository validatorRepository)
        {
