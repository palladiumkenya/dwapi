...
{
    public class TempMnchLabExtractRepository : BaseRepository<TempMnchLabExtract, Guid>, ITempMnchLabExtractRepository
    {
        public TempMnchLabExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempMnchLabExtract> extracts)
        {
