...
{
    public class TempIptExtractRepository : BaseRepository<TempIptExtract, Guid>, ITempIptExtractRepository
    {
        public TempIptExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempIptExtract> extracts)
        {
