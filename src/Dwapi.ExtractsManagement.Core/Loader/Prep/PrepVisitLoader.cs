    ...
    public class PrepVisitLoader : IPrepVisitLoader
    {
        ...
        public async Task<int> Load(Guid extractId, int found, bool diffSupport)
        {
            ...
            try
            {
                ...
                int extractssitecode = (int) _tempPrepVisitExtractRepository.GetSiteCode(query.ToString()).SiteCode;
                ...
                await _mediator.Publish(new DocketExtractLoaded("PREP", nameof(PrepVisitExtract), extractssitecode));
