...
{
    public partial class InitialMigrationPREPViews : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
	        if (migrationBuilder.ActiveProvider.ToLower().Contains("MySql".ToLower()))
	        {
		        migrationBuilder.Sql(@"alter table TempPatientPrepExtracts convert to character set utf8 collate utf8_unicode_ci;");
		        migrationBuilder.Sql(@"alter table TempPrepAdverseEventExtracts convert to character set utf8 collate utf8_unicode_ci;");
		        migrationBuilder.Sql(@"alter table TempPrepBehaviourRiskExtracts convert to character set utf8 collate utf8_unicode_ci;");
		        migrationBuilder.Sql(@"alter table TempPrepCareTerminationExtracts convert to character set utf8 collate utf8_unicode_ci;");
		        migrationBuilder.Sql(@"alter table TempPrepLabExtracts convert to character set utf8 collate utf8_unicode_ci;");
		        migrationBuilder.Sql(@"alter table TempPrepPharmacyExtracts convert to character set utf8 collate utf8_unicode_ci;");
		        migrationBuilder.Sql(@"alter table TempPrepVisitExtracts convert to character set utf8 collate utf8_unicode_ci;");

		        migrationBuilder.Sql(@"alter table PatientPrepExtracts convert to character set utf8 collate utf8_unicode_ci;");
		        migrationBuilder.Sql(@"alter table PrepAdverseEventExtracts convert to character set utf8 collate utf8_unicode_ci;");
		        migrationBuilder.Sql(@"alter table PrepBehaviourRiskExtracts convert to character set utf8 collate utf8_unicode_ci;");
		        migrationBuilder.Sql(@"alter table PrepCareTerminationExtracts convert to character set utf8 collate utf8_unicode_ci;"); 
		        migrationBuilder.Sql(@"alter table PrepLabExtracts convert to character set utf8 collate utf8_unicode_ci;");
		        migrationBuilder.Sql(@"alter table PrepPharmacyExtracts convert to character set utf8 collate utf8_unicode_ci;");
		        migrationBuilder.Sql(@"alter table PrepVisitExtracts convert to character set utf8 collate utf8_unicode_ci;");
