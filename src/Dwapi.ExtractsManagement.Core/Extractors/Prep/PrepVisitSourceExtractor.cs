...
namespace Dwapi.ExtractsManagement.Core.Extractors.Prep
{
    public class PrepVisitSourceExtractor : IPrepVisitSourceExtractor
    {
        ...
        private readonly ITempPrepVisitExtractRepository _extractRepository;

        public PrepVisitSourceExtractor(IPrepExtractSourceReader reader, IMediator mediator, ITempPrepVisitExtractRepository extractRepository)
        {
            _reader = reader;
            _mediator = mediator;
