...
{
    public class TempAllergiesChronicIllnessExtractRepository : BaseRepository<TempAllergiesChronicIllnessExtract, Guid>, ITempAllergiesChronicIllnessExtractRepository
    {
        public TempAllergiesChronicIllnessExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempAllergiesChronicIllnessExtract> extracts)
        {
