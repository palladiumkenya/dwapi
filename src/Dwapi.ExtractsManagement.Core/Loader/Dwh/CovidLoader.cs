    ...
    public class CovidLoader : ICovidLoader
    {
        ...
        public async Task<int> Load(Guid extractId, int found, bool diffSupport)
        {
            ...
            try
            {
                ...
                int extractssitecode = (int) _tempCovidExtractRepository.GetSiteCode(query.ToString()).SiteCode;
                ...
                await _mediator.Publish(new DocketExtractLoaded("NDWH", nameof(CovidExtract), extractssitecode));
