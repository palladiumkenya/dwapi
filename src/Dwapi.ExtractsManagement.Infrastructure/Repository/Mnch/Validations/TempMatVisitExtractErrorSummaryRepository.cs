...
{
    public class TempMatVisitExtractErrorSummaryRepository: TempMnchExtractErrorSummaryRepository<TempMatVisitExtractErrorSummary>, ITempMatVisitExtractErrorSummaryRepository{public TempMatVisitExtractErrorSummaryRepository(ExtractsContext context) : base(context){}}
}
