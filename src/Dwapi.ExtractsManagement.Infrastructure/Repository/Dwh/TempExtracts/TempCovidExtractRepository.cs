...
{
    public class TempCovidExtractRepository : BaseRepository<TempCovidExtract, Guid>, ITempCovidExtractRepository
    {
        public TempCovidExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempCovidExtract> extracts)
        {
