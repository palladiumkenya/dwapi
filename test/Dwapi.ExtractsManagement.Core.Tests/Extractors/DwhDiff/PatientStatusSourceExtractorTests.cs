...
{
    [TestFixture]
    public class DiffPatientStatusSourceExtractorTests
    {
        ...
        public void should_Extract(string name)
        {
            ...
            Assert.False(_extractsContext.TempPatientStatusExtracts.First().Date_Created.IsNullOrEmpty());
            Assert.False(_extractsContext.TempPatientStatusExtracts.First().Date_Last_Modified.IsNullOrEmpty());
