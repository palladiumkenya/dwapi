...
namespace Dwapi.ExtractsManagement.Infrastructure.Tests
{
    ...
    public class ExtractsContextTests
    {
        ...
        private const string MssqlConnection =
            "Data Source=.\\koske14;Initial Catalog=dwapidev;Persist Security Info=True;User ID=sa;Password=maun;MultipleActiveResultSets=True";

        private const string MysqlConnection = "server=192.168.100.51;port=3306;database=dwapidev;user=root;password=root";
