...
{
    [TestFixture]
    public class CwcVisitLoaderTests
    {
        private ICwcVisitLoader _loader;
        private ICwcVisitSourceExtractor _extractor;
        ...
        public void SetUp()
        {
            _loader = TestInitializer.ServiceProvider.GetService<ICwcVisitLoader>();
            _extractor = TestInitializer.ServiceProvider.GetService<ICwcVisitSourceExtractor>();
            _extract = _extracts.First(x => x.Name.IsSameAs(nameof(CwcVisitExtract)));
