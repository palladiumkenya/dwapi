...
{
    public partial class AddHTSRecordUUIDviews : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"						ALTER VIEW vTempHtsClientsExtractErrorSummary
						AS
             ...
             migrationBuilder.Sql($@"ALTER view vTempHtsClientsLinkageExtractError as SELECT  * FROM    TempHtsClientsLinkageExtracts WHERE   (CheckError = 1)");
             migrationBuilder.Sql(@"
                        ALTER VIEW vTempHtsClientsLinkageExtractErrorSummary
                        AS
                        SELECT
            ...
            migrationBuilder.Sql(@"ALTER view vTempHtsPartnerTracingExtractError as SELECT  * FROM TempHtsPartnerTracingExtracts WHERE (CheckError = 1)");
            migrationBuilder.Sql(@"
                        ALTER VIEW vTempHtsPartnerTracingExtractErrorSummary
                        AS
            ...
            migrationBuilder.Sql(@"ALTER view vTempHtsClientTracingExtractError as  SELECT * FROM TempHtsClientTracingExtracts WHERE   (CheckError = 1)");
            migrationBuilder.Sql(@"
                        ALTER VIEW vTempHtsClientTracingExtractErrorSummary
                        AS
                        SELECT ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated, 
                        ValidationError.RecordId, 
            ...
            migrationBuilder.Sql(@"ALTER view vTempHtsTestKitsExtractError as SELECT  *  FROM    TempHtsTestKitsExtracts WHERE   (CheckError = 1)");
            migrationBuilder.Sql(@"
                        ALTER VIEW vTempHtsTestKitsExtractErrorSummary
                        AS
                        SELECT ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated, 
                        ValidationError.RecordId, 
