...
{
    public class TempHtsClientsLinkageExtractRepository : BaseRepository<TempHtsClientLinkage, Guid>, ITempHtsClientsLinkageExtractRepository
    {
        public TempHtsClientsLinkageExtractRepository(ExtractsContext context) : base(context)
        {
        }
        ...
        public bool BatchInsert(IEnumerable<TempHtsClientLinkage> extracts)
        {
        ...
        public Task<int> GetCleanCount()
        {
            ...
            {
                var query = QueryUtil.LinkageCount;
