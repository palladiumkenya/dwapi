...
{
    public partial class AddRecordUUIDviews : Migration
    {
...
ALTER VIEW vTempPatientVisitExtractErrorSummary
	...
	SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated, ValidationError.RecordId,
			...
			vTempDepressionScreeningExtractError.Voided
	            ...
	            migrationBuilder.Sql(@"ALTER view vTempIITRiskScoresExtractError as SELECT * FROM TempIITRiskScoresExtracts WHERE (CheckError = 1)");

	            migrationBuilder.Sql(@"
				ALTER VIEW vTempIITRiskScoresExtractErrorSummary
				AS
				SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated,ValidationError.RecordId,
