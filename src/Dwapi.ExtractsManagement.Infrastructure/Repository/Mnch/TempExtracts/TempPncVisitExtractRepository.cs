...
{
    public class TempPncVisitExtractRepository : BaseRepository<TempPncVisitExtract, Guid>, ITempPncVisitExtractRepository
    {
        public TempPncVisitExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempPncVisitExtract> extracts)
        {
