...
{
    [TestFixture]
    public class DiffPatientLoaderTests
    {
        ...
        public void should_Load()
        {
            ...
            Assert.False(_extractsContext.PatientExtracts.First().Date_Created.IsNullOrEmpty());
            Assert.False(_extractsContext.PatientExtracts.First().Date_Last_Modified.IsNullOrEmpty());
