...
@Component({
  selector: 'liveapp-psmart-docket',
  templateUrl: './psmart-docket.component.html',
  styleUrls: ['./psmart-docket.component.scss']
})
export class PsmartDocketComponent implements OnInit {
