...
{
    public class TempCwcEnrolmentExtractRepository : BaseRepository<TempCwcEnrolmentExtract, Guid>, ITempCwcEnrolmentExtractRepository
    {
        public TempCwcEnrolmentExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempCwcEnrolmentExtract> extracts)
        {
