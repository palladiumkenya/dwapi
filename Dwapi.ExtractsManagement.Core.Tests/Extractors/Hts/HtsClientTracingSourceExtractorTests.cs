...
{ 
    ...
    public class HtsClientTracingSourceExtractorTests
    {
        ...
        public void should_Exract_From_Reader_MsSql()
        {
            ...
            var extractor = TestInitializer.ServiceProvider.GetService<IHtsClientTracingSourceExtractor>();
        ...
        public void should_Exract_From_Reader_MySql()
        {
            ...
            var extractor = TestInitializer.ServiceProviderMysql.GetService<IHtsClientTracingSourceExtractor>();
