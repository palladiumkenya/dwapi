...
namespace Dwapi.ExtractsManagement.Core.Profiles.Prep
{
        ...
        public PrepExtractProfile()
        {
            CreateMap<IDataRecord, TempPatientPrepExtract>()
                ...
                .ForMember(x => x.Date_Created,
                    o => o.MapFrom(s =>
                        s.GetOptionalNullDateOrDefault(nameof(TempPatientPrepExtract.Date_Created))))
                .ForMember(x => x.Date_Last_Modified,
                    o => o.MapFrom(s =>
                        s.GetOptionalNullDateOrDefault(nameof(TempPatientPrepExtract.Date_Last_Modified))));
            ...
            CreateMap<IDataRecord, TempPrepBehaviourRiskExtract>()
                ...
                .ForMember(x => x.Date_Created,
                    o => o.MapFrom(s =>
                        s.GetOptionalNullDateOrDefault(nameof(TempPrepBehaviourRiskExtract.Date_Created))))
                .ForMember(x => x.Date_Last_Modified,
                    o => o.MapFrom(s =>
                        s.GetOptionalNullDateOrDefault(nameof(TempPrepBehaviourRiskExtract.Date_Last_Modified))));
                //.ForMember(x => x.FacilityName,
          ...
          CreateMap<IDataRecord, TempPrepVisitExtract>()
              ...
              .ForMember(x => x.Date_Created,
                  o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempPrepVisitExtract.Date_Created))))
              .ForMember(x => x.Date_Last_Modified,
                  o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempPrepVisitExtract.Date_Last_Modified))));
                //.ForMember(x => x.FacilityName,
                  ...
                  CreateMap<IDataRecord, TempPrepLabExtract>()
                      ...
                      .ForMember(x => x.Date_Created,
                          o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempPrepLabExtract.Date_Created))))
                      .ForMember(x => x.Date_Last_Modified,
                          o => o.MapFrom(s =>
                              s.GetOptionalNullDateOrDefault(nameof(TempPrepLabExtract.Date_Last_Modified))));
             //   .ForMember(x => x.FacilityName,
               ...
               CreateMap<IDataRecord, TempPrepPharmacyExtract>()
                   ...
                   .ForMember(x => x.Date_Created,
                       o => o.MapFrom(s =>
                           s.GetOptionalNullDateOrDefault(nameof(TempPrepPharmacyExtract.Date_Created))))
                   .ForMember(x => x.Date_Last_Modified,
                       o => o.MapFrom(s =>
                           s.GetOptionalNullDateOrDefault(nameof(TempPrepPharmacyExtract.Date_Last_Modified))));
           //     .ForMember(x => x.FacilityName,
 ...
 CreateMap<IDataRecord, TempPrepAdverseEventExtract>()
     ...
     .ForMember(x => x.Date_Created,
         o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempPrepAdverseEventExtract.Date_Created))))
     .ForMember(x => x.Date_Last_Modified,
         o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempPrepAdverseEventExtract.Date_Last_Modified))));
               // .ForMember(x => x.FacilityName,
                 ...
                 CreateMap<IDataRecord, TempPrepCareTerminationExtract>()
                     ...
                     .ForMember(x => x.Date_Created,
                         o => o.MapFrom(s =>
                             s.GetOptionalNullDateOrDefault(nameof(TempPrepCareTerminationExtract.Date_Created))))
                     .ForMember(x => x.Date_Last_Modified,
                         o => o.MapFrom(s =>
                             s.GetOptionalNullDateOrDefault(nameof(TempPrepCareTerminationExtract
                                 .Date_Last_Modified))));
              //  .ForMember(x => x.FacilityName,
