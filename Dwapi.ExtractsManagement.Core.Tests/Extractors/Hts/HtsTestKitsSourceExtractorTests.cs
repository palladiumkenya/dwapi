...
{ 
    [TestFixture]
    public class HtsTestKitsSourceExtractorTests
    {
        ...
        public void should_Exract_From_Reader_MsSql()
        {
            ...
            var extractor = TestInitializer.ServiceProvider.GetService<IHtsTestKitsSourceExtractor>();
        ...
        public void should_Exract_From_Reader_MySql()
        {
            ...
            var extractor = TestInitializer.ServiceProviderMysql.GetService<IHtsTestKitsSourceExtractor>();
