...
namespace Dwapi.ExtractsManagement.Core.Profiles.Dwh
{
    public class TempExtractProfile : Profile
    {
        public TempExtractProfile()
        {
            ...
            CreateMap<IDataRecord,TempAllergiesChronicIllnessExtract>()
                ...
                .ForMember(x => x.FacilityId, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempAllergiesChronicIllnessExtract.FacilityId))))
  ...
  CreateMap<IDataRecord,TempContactListingExtract>()
                ...
                .ForMember(x => x.FacilityId, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempContactListingExtract.FacilityId))))
   ...
   .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempPatientAdverseEventExtract.Date_Last_Modified))));
            ...
            CreateMap<IDataRecord,TempDepressionScreeningExtract>()
                ...
                .ForMember(x => x.FacilityId, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempDepressionScreeningExtract.FacilityId))))
            ...
            CreateMap<IDataRecord,TempDrugAlcoholScreeningExtract>()
                ...
                .ForMember(x => x.FacilityId, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempDrugAlcoholScreeningExtract.FacilityId))))
                ...
                .ForMember(x => x.DrinkAlcohol, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempDrugAlcoholScreeningExtract.DrinkAlcohol))))
            ...
            CreateMap<IDataRecord, TempEnhancedAdherenceCounsellingExtract>()
                ...
                .ForMember(x => x.FacilityId, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempEnhancedAdherenceCounsellingExtract.FacilityId))))
...
.ForMember(x => x.MMSA4_2, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempEnhancedAdherenceCounsellingExtract.MMSA4_2))))
.ForMember(x => x.MMSA4_3, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempEnhancedAdherenceCounsellingExtract.MMSA4_3))))
.ForMember(x => x.MMSA4_4, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempEnhancedAdherenceCounsellingExtract.MMSA4_4))))
...
.ForMember(x => x.EACFollowupDate, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempEnhancedAdherenceCounsellingExtract.EACFollowupDate))))
            ...
            CreateMap<IDataRecord,TempGbvScreeningExtract>()
                ...
                .ForMember(x => x.FacilityId, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempGbvScreeningExtract.FacilityId))))
            ...
            CreateMap<IDataRecord,TempIptExtract>()
                ...
                .ForMember(x => x.FacilityId, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempIptExtract.FacilityId))))
...
.ForMember(x => x.VisitID, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempIptExtract.VisitID))))
...
.ForMember(x => x.Lethergy , o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempIptExtract.Lethergy ))))
...
.ForMember(x => x.StartIPT, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempIptExtract.StartIPT))))
.ForMember(x => x.IndicationForIPT, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempIptExtract.IndicationForIPT))))
                .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempPatientAdverseEventExtract.Date_Created))))
                .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempPatientAdverseEventExtract.Date_Last_Modified))));
;
            ...
            CreateMap<IDataRecord,TempOtzExtract>()
                ...
                .ForMember(x => x.FacilityId, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempOtzExtract.FacilityId))))
                ...
                .ForMember(x => x.VisitID, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempOtzExtract.VisitID))))
            ...
            CreateMap<TempOtzExtract,OtzExtract>();
               ...
               CreateMap<IDataRecord,TempOvcExtract>()
                ...
                .ForMember(x => x.FacilityId, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempOvcExtract.FacilityId))))
                ...
                .ForMember(x => x.FacilityName, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempOvcExtract.FacilityName))))
                .ForMember(x => x.VisitID, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempOvcExtract.VisitID))))
                ...
                .ForMember(x => x.EnrolledinCPIMS, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempOvcExtract.EnrolledinCPIMS))))
