...
import {ManifestResponse} from "../../../dockets/models/manifest-response";
import {EmrSetup} from "../../../settings/model/emr-setup";
import {el} from "@angular/platform-browser/testing/src/browser_util";

@Component({
    selector: 'liveapp-merged-ndwh-console',
    templateUrl: './merged-ndwh-console.component.html',
    styleUrls: ['./merged-ndwh-console.component.scss']
})
export class MergedNdwhConsoleComponent implements OnInit, OnChanges, OnDestroy {
    @Input() emr: EmrSystem;
    @Input() emrVer: string;
