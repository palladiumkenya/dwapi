...
{
    public class DiffMnchExtractProfile : Profile
    {
        public DiffMnchExtractProfile()
        {
            CreateMap<IDataRecord, TempPatientMnchExtract>()
                ...
                .ForMember(x => x.DOB, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPatientMnchExtract.DOB))))
                .ForMember(x => x.FirstEnrollmentAtMnch, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPatientMnchExtract.FirstEnrollmentAtMnch))))
                ...
                .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPatientMnchExtract.Date_Last_Modified))))
                .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPatientMnchExtract.Date_Last_Modified))))
                ;
            ...
            CreateMap<IDataRecord, TempMnchEnrolmentExtract>()
                ...
                .ForMember(x => x.EnrollmentDateAtMnch, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchEnrolmentExtract.EnrollmentDateAtMnch))))
                .ForMember(x => x.MnchNumber, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchEnrolmentExtract.MnchNumber))))
                .ForMember(x => x.FirstVisitAnc, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchEnrolmentExtract.FirstVisitAnc))))
                ...
                .ForMember(x => x.LMP, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchEnrolmentExtract.LMP))))
                .ForMember(x => x.EDDFromLMP, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchEnrolmentExtract.EDDFromLMP))))
                .ForMember(x => x.HIVStatusBeforeANC, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchEnrolmentExtract.HIVStatusBeforeANC))))
                .ForMember(x => x.HIVTestDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchEnrolmentExtract.HIVTestDate))))
                .ForMember(x => x.PartnerHIVStatus, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchEnrolmentExtract.PartnerHIVStatus))))
                .ForMember(x => x.PartnerHIVTestDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchEnrolmentExtract.PartnerHIVTestDate))))
            ...
            CreateMap<IDataRecord, TempMnchArtExtract>().ForMember(x => x.Pkv, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchArtExtract.Pkv))))
                ...
                .ForMember(x => x.RegistrationAtCCC, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchArtExtract.RegistrationAtCCC))))
                .ForMember(x => x.StartARTDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchArtExtract.StartARTDate))))
                ...
                .ForMember(x => x.LastARTDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchArtExtract.LastARTDate))))
...
.ForMember(x => x.VisitID, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.VisitID))))
.ForMember(x => x.VisitDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.VisitDate))))
.ForMember(x => x.ANCClinicNumber, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.ANCClinicNumber))))
.ForMember(x => x.ANCVisitNo, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.ANCVisitNo))))
.ForMember(x => x.GestationWeeks, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.GestationWeeks))))
.ForMember(x => x.Height, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.Height))))
.ForMember(x => x.Weight, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.Weight))))
.ForMember(x => x.Temp, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.Temp))))
.ForMember(x => x.PulseRate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.PulseRate))))
.ForMember(x => x.RespiratoryRate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.RespiratoryRate))))
.ForMember(x => x.OxygenSaturation, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.OxygenSaturation))))
.ForMember(x => x.MUAC, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.MUAC))))
...
.ForMember(x => x.Haemoglobin, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.Haemoglobin))))
...
.ForMember(x => x.WHOStaging, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.WHOStaging))))
.ForMember(x => x.VLSampleTaken, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.VLSampleTaken))))
.ForMember(x => x.VLDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.VLDate))))
...
.ForMember(x => x.MotherGivenHAART, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.MotherGivenHAART))))
...
.ForMember(x => x.NextAppointmentANC, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.NextAppointmentANC))))
...
.ForMember(x => x.VisitID, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.VisitID))))
.ForMember(x => x.VisitDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.VisitDate))))
.ForMember(x => x.AdmissionNumber, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.AdmissionNumber))))
.ForMember(x => x.ANCVisits, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.ANCVisits))))
.ForMember(x => x.DateOfDelivery, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.DateOfDelivery))))
.ForMember(x => x.DurationOfDelivery, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.DurationOfDelivery))))
.ForMember(x => x.GestationAtBirth, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.GestationAtBirth))))
...
.ForMember(x => x.BloodLoss, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.BloodLoss))))
...
.ForMember(x => x.MaternalDeath, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.MaternalDeath))))
.ForMember(x => x.DeliveryComplications, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.DeliveryComplications))))
.ForMember(x => x.NoBabiesDelivered, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.NoBabiesDelivered))))
.ForMember(x => x.BabyBirthNumber, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.BabyBirthNumber))))
...
.ForMember(x => x.ApgarScore1, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.ApgarScore1))))
.ForMember(x => x.ApgarScore5, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.ApgarScore5))))
.ForMember(x => x.ApgarScore10, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.ApgarScore10))))
...
.ForMember(x => x.VisitID, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.VisitID))))
.ForMember(x => x.VisitDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.VisitDate))))
.ForMember(x => x.PNCRegisterNumber, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.PNCRegisterNumber))))
.ForMember(x => x.PNCVisitNo, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.PNCVisitNo))))
.ForMember(x => x.DeliveryDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.DeliveryDate))))
...
.ForMember(x => x.Height, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.Height))))
.ForMember(x => x.Weight, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.Weight))))
.ForMember(x => x.Temp, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.Temp))))
.ForMember(x => x.PulseRate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.PulseRate))))
.ForMember(x => x.RespiratoryRate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.RespiratoryRate))))
.ForMember(x => x.OxygenSaturation, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.OxygenSaturation))))
.ForMember(x => x.MUAC, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.MUAC))))
.ForMember(x => x.BP, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.BP))))
...
.ForMember(x => x.NextAppointmentPNC, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.NextAppointmentPNC))))
.ForMember(x => x.ClinicalNotes, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.ClinicalNotes))))
            ...
            CreateMap<IDataRecord, TempMotherBabyPairExtract>()
                .ForMember(x => x.BabyPatientPK, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMotherBabyPairExtract.BabyPatientPK))))
                .ForMember(x => x.MotherPatientPK, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMotherBabyPairExtract.MotherPatientPK))))
...
.ForMember(x => x.VisitID, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcEnrolmentExtract.VisitID))))
...
.ForMember(x => x.BirthLength, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcEnrolmentExtract.BirthLength))))
.ForMember(x => x.BirthOrder, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcEnrolmentExtract.BirthOrder))))
...
.ForMember(x => x.VisitDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcVisitExtract.VisitDate))))
.ForMember(x => x.VisitID, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcVisitExtract.VisitID))))
.ForMember(x => x.Height, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcVisitExtract.Height))))
.ForMember(x => x.Weight, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcVisitExtract.Weight))))
.ForMember(x => x.Temp, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcVisitExtract.Temp))))
.ForMember(x => x.PulseRate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcVisitExtract.PulseRate))))
.ForMember(x => x.RespiratoryRate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcVisitExtract.RespiratoryRate))))
.ForMember(x => x.OxygenSaturation, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcVisitExtract.OxygenSaturation))))
.ForMember(x => x.MUAC, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcVisitExtract.MUAC))))
...
.ForMember(x => x.NextAppointment, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempCwcVisitExtract.NextAppointment))))
                .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPatientMnchExtract.Date_Last_Modified))))
                .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPatientMnchExtract.Date_Last_Modified))));
            ...
            CreateMap<IDataRecord, TempHeiExtract>()
                ...
                .ForMember(x => x.DNAPCR1Date, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempHeiExtract.DNAPCR1Date))))
                .ForMember(x => x.DNAPCR2Date, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempHeiExtract.DNAPCR2Date))))
                .ForMember(x => x.DNAPCR3Date, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempHeiExtract.DNAPCR3Date))))
                .ForMember(x => x.ConfirmatoryPCRDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempHeiExtract.ConfirmatoryPCRDate))))
                .ForMember(x => x.BasellineVLDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempHeiExtract.BasellineVLDate))))
                .ForMember(x => x.FinalyAntibodyDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempHeiExtract.FinalyAntibodyDate))))
                ...
                .ForMember(x => x.HEIExitDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempHeiExtract.HEIExitDate))))
                .ForMember(x => x.HEIHIVStatus, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempHeiExtract.HEIHIVStatus)))).ForMember(x => x.HEIExitCritearia, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempHeiExtract.HEIExitCritearia))))  .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPatientMnchExtract.Date_Last_Modified))))
                .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPatientMnchExtract.Date_Last_Modified))));
            ...
            CreateMap<IDataRecord, TempMnchLabExtract>()
                ...
                .ForMember(x => x.VisitID, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchLabExtract.VisitID))))
                .ForMember(x => x.OrderedbyDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchLabExtract.OrderedbyDate))))
                .ForMember(x => x.ReportedbyDate, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchLabExtract.ReportedbyDate))))
