...
{
    public class HtsPartnerTracingExtractRepository : BaseRepository<HtsPartnerTracing, Guid>, IHtsPartnerTracingExtractRepository
    {
        public HtsPartnerTracingExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<HtsPartnerTracing> extracts)
        {
        ...
        public IEnumerable<HtsPartnerTracing> GetView()
        {
