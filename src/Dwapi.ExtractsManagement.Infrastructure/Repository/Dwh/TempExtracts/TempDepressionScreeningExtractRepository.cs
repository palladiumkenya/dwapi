...
{
    public class TempDepressionScreeningExtractRepository : BaseRepository<TempDepressionScreeningExtract, Guid>, ITempDepressionScreeningExtractRepository
    {
        public TempDepressionScreeningExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempDepressionScreeningExtract> extracts)
        {
