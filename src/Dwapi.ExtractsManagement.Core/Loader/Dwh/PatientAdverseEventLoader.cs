...
namespace Dwapi.ExtractsManagement.Core.Loader.Dwh
{
    public class PatientAdverseEventLoader : IPatientAdverseEventLoader
    {
        ...
        public PatientAdverseEventLoader(IPatientAdverseEventExtractRepository patientAdverseEventExtractRepository, ITempPatientAdverseEventExtractRepository tempPatientAdverseEventExtractRepository, IMediator mediator)
        {
        ...
        public async Task<int> Load(Guid extractId, int found, bool diffSupport)
        {
            ...
            try
            {
                ...
                int extractssitecode = (int) _tempPatientAdverseEventExtractRepository.GetSiteCode(query.ToString()).SiteCode;
                ...
                await _mediator.Publish(new DocketExtractLoaded("NDWH", nameof(PatientAdverseEventExtract), extractssitecode));
