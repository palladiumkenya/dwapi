...
{
    [TestFixture]
    public class DiffPatientAdverseEventLoaderTests
    {
        ...
        public void should_Load()
        {
            ...
            Assert.False(_extractsContext.PatientAdverseEventExtracts.First().Date_Created.IsNullOrEmpty());
            Assert.False(_extractsContext.PatientAdverseEventExtracts.First().Date_Last_Modified.IsNullOrEmpty());
