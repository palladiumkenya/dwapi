...
{
    public class HtsPartnerNotificationServicesExtractRepository : BaseRepository<HtsPartnerNotificationServices, Guid>, IHtsPartnerNotificationServicesExtractRepository
    {
        public HtsPartnerNotificationServicesExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<HtsPartnerNotificationServices> extracts)
        {
        ...
        public IEnumerable<HtsPartnerNotificationServices> GetView()
        {
