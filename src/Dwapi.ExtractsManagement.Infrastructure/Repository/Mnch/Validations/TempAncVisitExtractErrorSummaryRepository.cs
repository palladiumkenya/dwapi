...
{
    public class TempAncVisitExtractErrorSummaryRepository: TempMnchExtractErrorSummaryRepository<TempAncVisitExtractErrorSummary>, ITempAncVisitExtractErrorSummaryRepository{public TempAncVisitExtractErrorSummaryRepository(ExtractsContext context) : base(context){}}
}
