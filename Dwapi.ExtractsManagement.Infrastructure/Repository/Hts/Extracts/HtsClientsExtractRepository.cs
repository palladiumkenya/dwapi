...
namespace Dwapi.ExtractsManagement.Infrastructure.Repository.Hts
{
    ...
    {
        public HtsClientsExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<HtsClients> extracts)
        {
        ...
        public IEnumerable<HtsClients> GetView()
        {
