...
{
    public class TempPatientStatusExtractRepository : BaseRepository<TempPatientStatusExtract, Guid>, ITempPatientStatusExtractRepository
    {
        public TempPatientStatusExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempPatientStatusExtract> extracts)
        {
