...
{
    public class TempMnchArtExtractRepository : BaseRepository<TempMnchArtExtract, Guid>, ITempMnchArtExtractRepository
    {
        public TempMnchArtExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempMnchArtExtract> extracts)
        {
