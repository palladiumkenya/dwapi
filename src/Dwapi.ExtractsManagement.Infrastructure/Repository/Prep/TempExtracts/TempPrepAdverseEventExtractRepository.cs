...
{
    public class TempPrepAdverseEventExtractRepository : BaseRepository<TempPrepAdverseEventExtract, Guid>, ITempPrepAdverseEventExtractRepository
    {
        public TempPrepAdverseEventExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempPrepAdverseEventExtract> extracts)
        {
