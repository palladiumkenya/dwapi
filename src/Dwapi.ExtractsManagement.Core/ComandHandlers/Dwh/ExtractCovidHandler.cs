...
{
    public class ExtractCovidHandler :IRequestHandler<ExtractCovid,bool>
    {
        private readonly ICovidSourceExtractor _CovidSourceExtractor;
        private readonly IExtractValidator _extractValidator;
        private readonly ICovidLoader _CovidLoader;
        ...
        public ExtractCovidHandler(ICovidSourceExtractor CovidSourceExtractor, IExtractValidator extractValidator, ICovidLoader CovidLoader, IClearDwhExtracts clearDwhExtracts, IExtractHistoryRepository extractHistoryRepository, IDiffLogRepository diffLogRepository,IIndicatorExtractRepository indicatorExtractRepository)
        {
        ...
        public async Task<bool> Handle(ExtractCovid request, CancellationToken cancellationToken)
        {
            ...
            var difflog = _diffLogRepository.GetLog("NDWH", "CovidExtract", mflcode);
            ...
            //Load
            int loaded = await _CovidLoader.Load(request.Extract.Id, found, request.DatabaseProtocol.SupportsDifferential);
