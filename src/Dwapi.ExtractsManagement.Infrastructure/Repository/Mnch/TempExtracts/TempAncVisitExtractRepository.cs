...
{
    public class TempAncVisitExtractRepository : BaseRepository<TempAncVisitExtract, Guid>, ITempAncVisitExtractRepository
    {
        public TempAncVisitExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempAncVisitExtract> extracts)
        {
