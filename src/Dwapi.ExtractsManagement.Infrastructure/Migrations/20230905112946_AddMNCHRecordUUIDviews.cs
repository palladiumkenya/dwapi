...
{
    public partial class AddMNCHRecordUUIDviews : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
	        ...
	        migrationBuilder.Sql(@"ALTER view vTempMnchEnrolmentExtractError as SELECT * FROM TempMnchEnrolmentExtracts WHERE (CheckError = 1)");
	        ...
	        migrationBuilder.Sql(@"ALTER view vTempMnchLabExtractError as SELECT * FROM TempMnchLabExtracts WHERE (CheckError = 1)");
	        ...
	        migrationBuilder.Sql(@"
					ALTER VIEW vTempMnchLabExtractErrorSummary
					AS
					SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated,ValidationError.RecordId,
	        ...
	        migrationBuilder.Sql(@"
					ALTER VIEW vTempMnchEnrolmentExtractErrorSummary
					AS
					SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated,ValidationError.RecordId,
