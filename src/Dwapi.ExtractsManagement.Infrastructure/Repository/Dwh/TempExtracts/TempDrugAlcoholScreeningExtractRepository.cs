...
{
    public class TempDrugAlcoholScreeningExtractRepository : BaseRepository<TempDrugAlcoholScreeningExtract, Guid>, ITempDrugAlcoholScreeningExtractRepository
    {
        public TempDrugAlcoholScreeningExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempDrugAlcoholScreeningExtract> extracts)
        {
