...
{
    public class CleanMgsExtracts : ICleanMgsExtracts
    {
        ...
        public CleanMgsExtracts(ITempMetricMigrationExtractRepository tempMetricMigrationExtractRepository, IExtractHistoryRepository historyRepository, IValidatorRepository validatorRepository)
        {
        ...
        public async Task Clean(List<Guid> extractIds)
        {
            ...
            DomainEvents.Dispatch(new MgsNotification(new ExtractProgress(nameof(MetricMigrationExtract), "cleared")));
        }
    }
}
