...
{
    public partial class InitialMigrationCTViews : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
					...
					vTempContactListingExtractError.Voided
            ...
            migrationBuilder.Sql(@"CREATE  view vTempPatientVisitExtractError as SELECT * FROM TempPatientVisitExtracts WHERE (CheckError = 1)");
				 migrationBuilder.Sql(@"
CREATE  VIEW vTempPatientVisitExtractErrorSummary
                ...
                ");
				 ...
				 migrationBuilder.Sql(@"CREATE  view vTempPatientExtractError as SELECT * FROM TempPatientExtracts WHERE (CheckError = 1)");
            migrationBuilder.Sql(@"
						...
						vTempPatientExtractError.Voided
            ...
            migrationBuilder.Sql(@"CREATE  view vTempPatientArtExtractError as SELECT * FROM TempPatientArtExtracts WHERE (CheckError = 1)");
            migrationBuilder.Sql(@"CREATE  view vTempPatientBaselinesExtractError as SELECT * FROM TempPatientBaselinesExtracts WHERE (CheckError = 1)");
            migrationBuilder.Sql(@"CREATE  view vTempPatientLaboratoryExtractError as SELECT * FROM TempPatientLaboratoryExtracts WHERE (CheckError = 1)");
            migrationBuilder.Sql(@"CREATE  view vTempPatientPharmacyExtractError as SELECT * FROM TempPatientPharmacyExtracts WHERE (CheckError = 1)");
            migrationBuilder.Sql(@"CREATE  view vTempPatientStatusExtractError as SELECT * FROM TempPatientStatusExtracts WHERE (CheckError = 1)");
            migrationBuilder.Sql(@"CREATE  view vTempPatientAdverseEventExtractError as SELECT * FROM TempPatientAdverseEventExtracts WHERE (CheckError = 1)");
            ...
            migrationBuilder.Sql(@"CREATE  view vTempCovidExtractError as SELECT * FROM TempCovidExtracts WHERE (CheckError = 1)");
            migrationBuilder.Sql(@"CREATE  view vTempDefaulterTracingExtractError as SELECT * FROM TempDefaulterTracingExtracts WHERE (CheckError = 1)");
			...
			migrationBuilder.Sql(@"
				...
				SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated, vTempPatientArtExtractError.PatientPK,vTempPatientArtExtractError.FacilityId,
							...
							vTempPatientArtExtractError.Voided
	...
	SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated, vTempPatientBaselinesExtractError.PatientPK,vTempPatientBaselinesExtractError.FacilityId,
							...
							vTempPatientBaselinesExtractError.Voided
	...
	SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated, vTempPatientLaboratoryExtractError.PatientPK,vTempPatientLaboratoryExtractError.FacilityId,
							...
							vTempPatientLaboratoryExtractError.Voided
	...
	SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated, vTempPatientPharmacyExtractError.PatientPK,vTempPatientPharmacyExtractError.FacilityId,
							...
							vTempPatientPharmacyExtractError.Voided
	...
	SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated, vTempPatientStatusExtractError.PatientPK,vTempPatientStatusExtractError.FacilityId,
							...
							vTempPatientStatusExtractError.Voided
	...
	FROM            vTempPatientStatusExtractError INNER JOIN
			...
			SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated, vTempPatientAdverseEventExtractError.PatientPK,vTempPatientAdverseEventExtractError.FacilityId,
							...
							vTempPatientAdverseEventExtractError.Voided
			...
			FROM            vTempPatientAdverseEventExtractError INNER JOIN
				...
				SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated,ValidationError.RecordId,
							...
							vTempCervicalCancerScreeningExtractError.Voided
	...
	SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated, ValidationError.RecordId,
			...
			vTempGbvScreeningExtractError.RecordUUID,
				vTempGbvScreeningExtractError.Voided
			...
			vTempEnhancedAdherenceCounsellingExtractError.Voided
			...
			vTempDrugAlcoholScreeningExtractError.RecordUUID,
				vTempDrugAlcoholScreeningExtractError.Voided
			...
			vTempDepressionScreeningExtractError.Voided
				...
				SELECT        ValidationError.Id, Validator.Extract, Validator.Field, Validator.Type, Validator.Summary, ValidationError.DateGenerated,ValidationError.RecordId,
							...
							vTempIITRiskScoresExtractError.Voided	
