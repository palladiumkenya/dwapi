...
{
    public class TempPrepLabExtractRepository : BaseRepository<TempPrepLabExtract, Guid>, ITempPrepLabExtractRepository
    {
        public TempPrepLabExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempPrepLabExtract> extracts)
        {
