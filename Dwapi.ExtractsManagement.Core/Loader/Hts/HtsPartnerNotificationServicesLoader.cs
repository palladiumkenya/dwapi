...
{ 
    ...
    {
        private readonly IHtsPartnerNotificationServicesExtractRepository _patientExtractRepository;
        ...
        public HtsPartnerNotificationServicesLoader(IHtsPartnerNotificationServicesExtractRepository patientExtractRepository, ITempHtsPartnerNotificationServicesExtractRepository tempPatientExtractRepository)
        {
        ...
        public Task<int> Load()
        {
            try
            {
                ...
                //Auto mapper
                var extractRecords = Mapper.Map<List<TempHtsPartnerNotificationServices>, List<HtsPartnerNotificationServices>>(tempPatientExtracts);
