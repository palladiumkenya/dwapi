    ...
    public partial class Mnch : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_TempAncVisitExtracts", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_TempCwcEnrolmentExtracts", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_TempCwcVisitExtracts", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_TempHeiExtracts", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_TempMatVisitExtracts", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_TempMnchArtExtracts", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_TempMnchEnrolmentExtracts", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_TempMnchLabExtracts", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_TempMotherBabyPairExtracts", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_TempPatientMnchExtracts", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_TempPncVisitExtracts", x => x.Id); });
            ...
            if (migrationBuilder.ActiveProvider.ToLower().Contains("MySql".ToLower()))
            {
                ...
                migrationBuilder.Sql(
                    @"alter table PatientMnchExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table MnchEnrolmentExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table MnchArtExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table AncVisitExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table MatVisitExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table PncVisitExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table MotherBabyPairExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table CwcEnrolmentExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table CwcVisitExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(@"alter table HeiExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table MnchLabExtracts convert to character set utf8 collate utf8_unicode_ci;");

                migrationBuilder.Sql(
                    @"alter table TempPatientMnchExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table TempMnchEnrolmentExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table TempMnchArtExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table TempAncVisitExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table TempMatVisitExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table TempPncVisitExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table TempMotherBabyPairExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table TempCwcEnrolmentExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table TempCwcVisitExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table TempHeiExtracts convert to character set utf8 collate utf8_unicode_ci;");
                migrationBuilder.Sql(
                    @"alter table TempMnchLabExtracts convert to character set utf8 collate utf8_unicode_ci;");
