    ...
    public class MnchExtractProfile : Profile
    {
     ...
     CreateMap<IDataRecord, TempPatientMnchExtract>()
         ...
         .ForMember(x => x.Emr, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPatientMnchExtract.Emr))))
                    ...
                    .ForMember(x => x.NUPI, o => o.MapFrom(s => s.GetOptionalStringOrDefault(nameof(TempPatientMnchExtract.NUPI))))
         .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempPatientMnchExtract.Date_Created))))
         .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempPatientMnchExtract.Date_Last_Modified))));
                 ...
                 CreateMap<IDataRecord, TempMnchEnrolmentExtract>()
                     ...
                     .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempMnchEnrolmentExtract.Date_Created))))
                     .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempMnchEnrolmentExtract.Date_Last_Modified))));
                 ...
                 CreateMap<IDataRecord, TempMnchArtExtract>().ForMember(x => x.Pkv, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchArtExtract.Pkv))))
                     ...
                     .ForMember(x => x.FacilityReceivingARTCare, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchArtExtract.FacilityReceivingARTCare))))
                     .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempMnchArtExtract.Date_Created))))
                     .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempMnchArtExtract.Date_Last_Modified))));
                 ...
                 CreateMap<IDataRecord, TempAncVisitExtract>()
                     ...
                     .ForMember(x => x.HepatitisBScreening, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.HepatitisBScreening))))
                     .ForMember(x => x.TreatedHepatitisB, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.TreatedHepatitisB))))
                     .ForMember(x => x.PresumptiveTreatmentGiven, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.PresumptiveTreatmentGiven))))
                     .ForMember(x => x.PresumptiveTreatmentDose, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.PresumptiveTreatmentDose))))
                     .ForMember(x => x.MiminumPackageOfCareReceived, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.MiminumPackageOfCareReceived))))
                     .ForMember(x => x.MiminumPackageOfCareServices, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempAncVisitExtract.MiminumPackageOfCareServices))))
                     .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempAncVisitExtract.Date_Created))))
                     .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempAncVisitExtract.Date_Last_Modified))));
        ...
        CreateMap<IDataRecord, TempMatVisitExtract>()
                 ...
                 .ForMember(x => x.LMP, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMatVisitExtract.LMP))))
                 .ForMember(x => x.EDD, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMatVisitExtract.EDD))))
                 .ForMember(x => x.MaternalDeathAudited, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.MaternalDeathAudited))))
                 .ForMember(x => x.ReferralReason, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.ReferralReason))))
                 .ForMember(x => x.OnARTMat, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMatVisitExtract.OnARTMat))))
                 .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempMatVisitExtract.Date_Created))))
                 .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempMatVisitExtract.Date_Last_Modified))));
                 ...
                 CreateMap<IDataRecord, TempPncVisitExtract>()
                     ...
                     .ForMember(x => x.VisitTimingMother, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.VisitTimingMother))))
                     .ForMember(x => x.VisitTimingBaby, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.VisitTimingBaby))))
                     .ForMember(x => x.MotherCameForHIVTest, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.MotherCameForHIVTest))))
                     .ForMember(x => x.InfactCameForHAART, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.InfactCameForHAART))))
                     .ForMember(x => x.MotherGivenHAART, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPncVisitExtract.MotherGivenHAART))))
                     .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempPncVisitExtract.Date_Created))))
                     .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempPncVisitExtract.Date_Last_Modified))));
                 ...
                 CreateMap<IDataRecord, TempMotherBabyPairExtract>()
                     ...
                     .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempMotherBabyPairExtract.Date_Created))))
                     .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempMotherBabyPairExtract.Date_Last_Modified))));
                 ...
                 CreateMap<IDataRecord, TempCwcEnrolmentExtract>()
                     ...
                     .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempCwcEnrolmentExtract.Date_Created))))
                     .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempCwcEnrolmentExtract.Date_Last_Modified))));
                 ...
                 CreateMap<IDataRecord, TempCwcVisitExtract>()
                     ...
                     .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempCwcVisitExtract.Date_Created))))
                     .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempCwcVisitExtract.Date_Last_Modified))));
                 ...
                 CreateMap<IDataRecord, TempHeiExtract>()
                     ...
                     .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempHeiExtract.Date_Created))))
                     .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempHeiExtract.Date_Last_Modified))));
                 ...
                 CreateMap<IDataRecord, TempMnchLabExtract>()
                     ...
                     .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempMnchLabExtract.Date_Created))))
                     .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempMnchLabExtract.Date_Last_Modified))));



                 CreateMap<IDataRecord, TempMnchImmunizationExtract>()
                     .ForMember(x => x.PatientPK, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempPatientMnchExtract.PatientPK))))
                     .ForMember(x => x.SiteCode, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempPatientMnchExtract.SiteCode))))
                     .ForMember(x => x.FacilityId, o => o.MapFrom(s => s.GetNullIntOrDefault(nameof(TempPatientMnchExtract.FacilityId))))
                     .ForMember(x => x.Project, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPatientMnchExtract.Project))))
                     .ForMember(x => x.Emr, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempPatientMnchExtract.Emr))))
                     .ForMember(x => x.FacilityName, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchImmunizationExtract.FacilityName))))
                        .ForMember(x => x.PatientMnchID, o => o.MapFrom(s => s.GetStringOrDefault(nameof(TempMnchImmunizationExtract.PatientMnchID))))
                        .ForMember(x => x.BCG, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.BCG))))
                        .ForMember(x => x.OPVatBirth, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.OPVatBirth))))
                        .ForMember(x => x.OPV1, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.OPV1))))
                        .ForMember(x => x.OPV2, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.OPV2))))
                        .ForMember(x => x.OPV3, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.OPV3))))
                        .ForMember(x => x.IPV, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.IPV))))
                        .ForMember(x => x.DPTHepBHIB1, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.DPTHepBHIB1))))
                        .ForMember(x => x.DPTHepBHIB2, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.DPTHepBHIB2))))
                        .ForMember(x => x.DPTHepBHIB3, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.DPTHepBHIB3))))
                        .ForMember(x => x.PCV101, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.PCV101))))
                        .ForMember(x => x.PCV102, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.PCV102))))
                        .ForMember(x => x.PCV103, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.PCV103))))
                        .ForMember(x => x.ROTA1, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.ROTA1))))
                        .ForMember(x => x.MeaslesReubella1, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.MeaslesReubella1))))
                        .ForMember(x => x.YellowFever, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.YellowFever))))
                        .ForMember(x => x.MeaslesReubella2, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.MeaslesReubella2))))
                        .ForMember(x => x.MeaslesAt6Months, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.MeaslesAt6Months))))
                        .ForMember(x => x.ROTA2, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.ROTA2))))
                        .ForMember(x => x.DateOfNextVisit, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.DateOfNextVisit))))
                        .ForMember(x => x.BCGScarChecked, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.BCGScarChecked))))
                        .ForMember(x => x.DateChecked, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.DateChecked))))
                        .ForMember(x => x.DateBCGrepeated, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.DateBCGrepeated))))
                        .ForMember(x => x.VitaminAAt6Months, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.VitaminAAt6Months))))
                        .ForMember(x => x.VitaminAAt1Yr, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.VitaminAAt1Yr))))
                        .ForMember(x => x.VitaminAAt18Months, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.VitaminAAt18Months))))
                        .ForMember(x => x.VitaminAAt2Years, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.VitaminAAt2Years))))
                        .ForMember(x => x.VitaminAAt2To5Years, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.VitaminAAt2To5Years))))
                        .ForMember(x => x.FullyImmunizedChild, o => o.MapFrom(s => s.GetNullDateOrDefault(nameof(TempMnchImmunizationExtract.FullyImmunizedChild))))
                     .ForMember(x => x.Date_Created, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempMnchImmunizationExtract.Date_Created))))
                     .ForMember(x => x.Date_Last_Modified, o => o.MapFrom(s => s.GetOptionalNullDateOrDefault(nameof(TempMnchImmunizationExtract.Date_Last_Modified))));
                 ...
                 CreateMap<TempMnchImmunizationExtract, MnchImmunizationExtract>();
