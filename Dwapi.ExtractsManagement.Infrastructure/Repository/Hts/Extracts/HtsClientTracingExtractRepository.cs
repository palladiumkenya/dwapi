...
{
    public class HtsClientTracingExtractRepository : BaseRepository<HtsClientTracing, Guid>, IHtsClientTracingExtractRepository
    {
        public HtsClientTracingExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<HtsClientTracing> extracts)
        {
        ...
        public IEnumerable<HtsClientTracing> GetView()
        {
