...
{
    public class TempGbvScreeningExtractRepository : BaseRepository<TempGbvScreeningExtract, Guid>, ITempGbvScreeningExtractRepository
    {
        public TempGbvScreeningExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempGbvScreeningExtract> extracts)
        {
