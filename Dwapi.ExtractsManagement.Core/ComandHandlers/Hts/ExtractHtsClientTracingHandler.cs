...
{ 
    public class ExtractHtsClientTracingHandler : IRequestHandler<ExtractHtsClientTracing, bool>
    {
        private readonly IHtsClientTracingSourceExtractor _patientSourceExtractor;
        private readonly IHtsExtractValidator _extractValidator;
        private readonly IHtsClientTracingLoader _patientLoader;
        ...
        public async Task<bool> Handle(ExtractHtsClientTracing request, CancellationToken cancellationToken)
        {
            ...
            //Validate
            await _extractValidator.Validate(request.Extract.Id, found, "HtsClientTracing", "TempHtsClientTracing");
