...
{
    public class TempMatVisitExtractRepository : BaseRepository<TempMatVisitExtract, Guid>, ITempMatVisitExtractRepository
    {
        public TempMatVisitExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempMatVisitExtract> extracts)
        {
