...
{
    public class TempCwcVisitExtractErrorSummaryRepository: TempMnchExtractErrorSummaryRepository<TempCwcVisitExtractErrorSummary>, ITempCwcVisitExtractErrorSummaryRepository{public TempCwcVisitExtractErrorSummaryRepository(ExtractsContext context) : base(context){}}
}
