...
{
    public class TempMnchImmunizationExtractRepository : BaseRepository<TempMnchImmunizationExtract, Guid>, ITempMnchImmunizationExtractRepository
    {
        public TempMnchImmunizationExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempMnchImmunizationExtract> extracts)
        {
