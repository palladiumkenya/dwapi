...
{
    public class HtsRiskScoresExtractRepository : BaseRepository<HtsRiskScores, Guid>, IHtsRiskScoresRepository
    {
        public HtsRiskScoresExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<HtsRiskScores> extracts)
        {
        ...
        public IEnumerable<HtsRiskScores> GetView()
        {
