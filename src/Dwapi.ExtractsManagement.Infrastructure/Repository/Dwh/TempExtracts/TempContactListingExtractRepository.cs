...
{
    public class TempContactListingExtractRepository : BaseRepository<TempContactListingExtract, Guid>, ITempContactListingExtractRepository
    {
        public TempContactListingExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempContactListingExtract> extracts)
        {
