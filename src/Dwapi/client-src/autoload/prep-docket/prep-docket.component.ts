...
@Component({
  selector: 'liveapp-merged-prep-docket',
  templateUrl: './prep-docket.component.html',
  styleUrls: ['./prep-docket.component.scss']
})
export class MergedPrepDocketComponent implements OnInit, OnDestroy {
