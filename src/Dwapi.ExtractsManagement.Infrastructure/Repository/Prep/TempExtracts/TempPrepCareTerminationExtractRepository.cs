...
{
    public class TempPrepCareTerminationExtractRepository : BaseRepository<TempPrepCareTerminationExtract, Guid>, ITempPrepCareTerminationExtractRepository
    {
        public TempPrepCareTerminationExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempPrepCareTerminationExtract> extracts)
        {
