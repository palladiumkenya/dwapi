...
{
    public class TempArtFastTrackExtractRepository : BaseRepository<TempArtFastTrackExtract, Guid>, ITempArtFastTrackExtractRepository
    {
        public TempArtFastTrackExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempArtFastTrackExtract> extracts)
        {
