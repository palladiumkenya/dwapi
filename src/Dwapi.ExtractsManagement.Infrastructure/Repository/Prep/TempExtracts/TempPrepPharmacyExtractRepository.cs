...
{
    public class TempPrepPharmacyExtractRepository : BaseRepository<TempPrepPharmacyExtract, Guid>, ITempPrepPharmacyExtractRepository
    {
        public TempPrepPharmacyExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempPrepPharmacyExtract> extracts)
        {
