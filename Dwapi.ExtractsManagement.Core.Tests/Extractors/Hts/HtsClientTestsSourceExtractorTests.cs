...
{ 
    [TestFixture]
    public class HtsClientTestsSourceExtractorTests
    {
        ...
        public void should_Exract_From_Reader_MsSql()
        {
            ...
            var extractor = TestInitializer.ServiceProvider.GetService<IHtsClientTestsSourceExtractor>();
        ...
        public void should_Exract_From_Reader_MySql()
        {
            ...
            var extractor = TestInitializer.ServiceProviderMysql.GetService<IHtsClientTestsSourceExtractor>();
