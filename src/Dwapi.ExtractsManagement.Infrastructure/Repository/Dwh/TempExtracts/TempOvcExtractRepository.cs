...
{
    public class TempOvcExtractRepository : BaseRepository<TempOvcExtract, Guid>, ITempOvcExtractRepository
    {
        public TempOvcExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempOvcExtract> extracts)
        {
