...
{
    public class TempPatientVisitExtractRepository : BaseRepository<TempPatientVisitExtract, Guid>, ITempPatientVisitExtractRepository
    {
        public TempPatientVisitExtractRepository(ExtractsContext context) : base(context)
        {
        }

        public bool BatchInsert(IEnumerable<TempPatientVisitExtract> extracts)
        {
